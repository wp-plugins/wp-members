...
WP-Members™ is a free membership management system for WordPress® restricts content to registered users.
...
The plugin adds provides additional custom fields to the registration process to include name, address, phone, and email.  All of the registration process is inline with your theme and content rather than using the WordPress® login page.  This offers you a premium content site with a professional and branded look and feel.  It also provides an opportunity for the user to register without leaving the page to do so - less clicks = more conversions.
