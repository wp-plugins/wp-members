...
WP-Members 3.1.5.1 includes raw data shortcode support.
...
* Adds [wpmem_field] support for raw data display for select (dropdown), multiple select, multiple checkbox, and radio groups.
